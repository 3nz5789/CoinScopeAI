# /archive — quarantine for historical files (frozen pre-2026-04-18)

**Status:** frozen — do not add to. For newly-superseded files (post-2026-04-18), use `../99-archive/`.
**Audience:** maintainers
**Related:** `docs/repo-audit.md`, `../99-archive/README.md`
