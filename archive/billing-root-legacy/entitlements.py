...
─────
  ...
  ents = Entitlements.for_tier("trader")
...
TIER_ENTITLEMENTS: dict[str, Entitlements] = {
    ...
    "desk_full": Entitlements(
        ...
        annual_price_usd_cents=1438800,
        max_symbols=-1,
...
_TIER_ORDER = ["unknown", "free", "trader", "desk_preview", "desk_full"]
