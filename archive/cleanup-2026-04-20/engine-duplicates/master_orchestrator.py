...
class CoinScopeOrchestrator:
    ...
    def __init__(self, testnet: bool = True, pairs: list = None):
        # BUG-17 FIX: ccxt.binance routes to SPOT testnet (testnet.binance.vision).
        # For USDT-margined futures use ccxt.binanceusdm; set_sandbox_mode(True)
        # routes OHLCV fetches to the Futures testnet (demo-fapi.binance.com).
