...
STRIPE_PRICE_DESK_FULL_MONTHLY=price_...
STRIPE_PRICE_DESK_FULL_ANNUAL=price_...
```
...
|---------------|---------------|-----------------|
| Free          | $0.00/mo      | $0.00/yr        |
| Trader        | $79.00/mo     | $758.40/yr      |
| Desk Preview  | $399.00/mo    | $3,830.40/yr    |
| Desk Full     | $1,199.00/mo  | $11,510.40/yr   |
...
curl -X POST http://localhost:8002/billing/checkout/session \
  ...
  -d '{"tier": "trader", "interval": "monthly", "customer_email": "test@example.com"}'
```
