...
| I13 | ML / LLM is not imported on the hot path | 🟡 | `docs/decisions/adr-0003-llm-off-hot-path.md` | `tests/test_directory_boundaries.py` | `tests/test_directory_boundaries.py` | `docs/validation/p0-evidence-pack.md` | Current tests provide hot-path import-isolation evidence. The ADR is the canonical design decision; the stronger AI-explanatory-only/non-authoritative contract remains unimplemented and I13 stays yellow. Tracked: issue [#59](https://github.com/3nz5789/CoinScopeAI/issues/59) |
