...
# ── Canonical Track B pricing — MUST match billing/config.py ─────────────────
TIERS = [
    {
    ...
    },
    {
        ...
        "description": (
            ...
            "Kelly position sizing, walk-forward validation."
        ),
    },
    {
        ...
        "description": (
            ...
            "full engine API access, up to 5 seats, priority support."
        ),
    },
    {
        "name": "CoinScopeAI Desk Full",
        "env_prefix": "DESK_FULL",
        "monthly_cents": 119900,  # $1,199.00/mo
        "annual_cents": 1151040,  # $11,510.40/yr (≈20% off)
        "description": (
            "Everything in Desk Preview. 5min scan interval, higher API rate "
            "limits, up to 25 seats, white-label dashboard, dedicated onboarding, "
